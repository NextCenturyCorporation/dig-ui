...
module.exports = function(app) {
  ...
  if ('production' === env) {
    ...
    app.use('/dig-ui/4IQ-logo.png', express.static(path.join(serverConfig.root, 'dist/4IQ-logo.png')));
  ...
  if ('development' === env || 'test' === env) {
    ...
    app.use('/dig-ui/4IQ-logo.png', express.static(path.join(serverConfig.root, 'app/4IQ-logo.png')));
